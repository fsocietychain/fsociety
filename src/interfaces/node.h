...
//! Interface for the src/evo part of a fsociety node (fsocietyd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a fsociety node (fsocietyd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a fsociety node (fsocietyd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a fsociety node (fsocietyd process).
class Node
{
public:
    virtual ~Node() {}
