...
#error Client version information missing: version is not defined by fsociety-config.h or in any other way
#endif
...
/**
 * fsocietyd-res.rc includes this file, but it cannot cope with real c++ code.
