...
#if defined(NDEBUG)
# error "Fsociety Core cannot be compiled without assertions."
#endif
                                     ...
                                     const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool fDryRun)
{
    ...
    for (const CTxIn &txin : tx.vin)
    {
        ...
        if (itConflicting != pool.mapNextTx.end())
        {
            ...
            // Transaction conflicts with mempool and RBF doesn't exist in Fsociety
...
static int64_t nTimeFsocietySpecific = 0;
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    int64_t nTime5 = GetTimeMicros(); nTimeFsocietySpecific += nTime5 - nTime4;
    LogPrint(BCLog::BENCHMARK, "    - Fsociety specific: %.2fms [%.2fs (%.2fms/blk)]\n", MILLI * (nTime5 - nTime4), nTimeFsocietySpecific * MICRO, nTimeFsocietySpecific * MILLI / nBlocksTotal);
