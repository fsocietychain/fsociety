...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Fsociety address"));
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    coinJoinCoinsMenuAction = new QAction("&CoinJoin", this);
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Fsociety address").arg("CoinJoin"));
    ...
    aboutAction->setStatusTip(tr("Show information about Fsociety Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fsociety addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fsociety addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Fsociety command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Fsociety Core"); // default title
