...
/** Class encapsulating Fsociety Core startup and shutdown.
...
/** Main Fsociety application object */
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Fsociety Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
static void SetupUIArgs()
{
    ...
    gArgs.AddArg("-windowtitle=<name>", _("Sets a window title which is appended to \"Fsociety Core - \""), false, OptionsCategory::GUI);
}
