Contributing to Fsociety Core
============================

The Fsociety Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fsociety Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Fsociety
Network Protocol consensus changes.

Whether a pull request is merged into Fsociety Core rests with the project merge
...
Patches that change Fsociety consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fsociety consensus, it must have been
...
The review process is normally fairly responsive on the Fsociety Core repository, however
...
The project leader is the release manager for each Fsociety Core release.
