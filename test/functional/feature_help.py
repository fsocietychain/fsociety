...
"""Verify that starting fsocietyd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fsocietyd with -h for help text")
        ...
        self.log.info("Start fsocietyd with -version for version information")
