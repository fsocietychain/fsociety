...
* fsociety.conf: contains configuration settings for fsocietyd or fsociety-qt
* fsocietyd.pid: stores the process id of fsocietyd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by fsocietyd or fsociety-qt
